...
public class KolmogorovSmirnovFitnesser extends Fitnesser {
	
	public KolmogorovSmirnovFitnesser() {
		super();
	...
	protected double calculate() {
        ...
        double error = ksTest.kolmogorovSmirnovStatistic(expectedArray, obtainedArray);
	...
	public Fitnesser copy(int obtainedFrequenciesIndex) {
		KolmogorovSmirnovFitnesser result = new KolmogorovSmirnovFitnesser();
